...
_POSTPROCESS_CONFIG = {
    "texture": {
        "name": "贴图",
        "step_name": "贴图操作",
        "module": "setps.texture_operation.v1_0_0.impl",
        "default_timeout_sec": 90.0,
    },
    "gaussian": {
        "name": "高斯渲染",
        "step_name": "高斯渲染操作",
        "module": "setps.gaussian_rendering.v1_0_0.impl",
...
def _run_import_project_step(
    ...
    try:
        ...
        from setps.import_project.v1_0_0.impl import run as run_import_project
    except ImportError as exc:
...
def _run_return_home_step(label: str) -> None:
    try:
        from airtest.core.error import AirtestError  # type: ignore
        from setps.return_home.v1_0_0.impl import run as run_return_home
    except ImportError as exc:
